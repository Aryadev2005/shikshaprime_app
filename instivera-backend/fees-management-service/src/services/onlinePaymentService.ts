...
export class OnlinePaymentService {  
  ...
  async processOnlinePayment(orderId: string, tenant: string) {
    ...
    return await sequelize.transaction(async (t) => {
      ...
      const studentId = studentPayment.student_id ? studentPayment.student_id : null;
      const applicationId = studentPayment.application_id ? studentPayment.application_id : null;
