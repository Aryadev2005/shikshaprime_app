...
export function defineNotice(sequelize: Sequelize): ModelStatic<Notice> {
  const existingNoticeModel = sequelize.models.Notice as ModelStatic<Notice> | undefined;
  if (existingNoticeModel) {
    return existingNoticeModel;
  }
