...
export interface StaffDailyAttendanceAttributes {
  ...
  attendance_status: 'PRESENT' | 'ABSENT' | 'LATE' | 'HALF_DAY' | 'HOLIDAY' | 'LEAVE' | 'ON_DUTY';
...
class StaffDailyAttendance extends Model<StaffDailyAttendanceAttributes, StaffDailyAttendanceCreationAttributes>
  ...
  public attendance_status!: 'PRESENT' | 'ABSENT' | 'LATE' | 'HALF_DAY' | 'HOLIDAY' | 'LEAVE' | 'ON_DUTY';
  ...
  StaffDailyAttendance.init(
    {
      ...
      attendance_status: {
        type: DataTypes.ENUM('PRESENT', 'ABSENT', 'LATE', 'HALF_DAY', 'HOLIDAY', 'LEAVE', 'ON_DUTY'),
        allowNull: false,
      },
      check_in_time: {
        type: DataTypes.TIME,
