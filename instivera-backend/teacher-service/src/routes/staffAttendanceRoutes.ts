...
// Get attendance overview for donut/pie chart widget (accessible by teachers and admins)
router.get("/overview", requireRole("teacher", "admin", "superadmin", "super_admin"), getStaffAttendanceOverview);
