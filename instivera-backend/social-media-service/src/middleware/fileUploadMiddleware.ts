...
const fileFilter = (req: any, file: any, cb: any) => {
  ...
  if (allowedTypes.includes(file.mimetype)) {
    ...
    const error = new Error(`File type ${file.mimetype} not allowed. Supported types: PDF, DOC, DOCX, XLS, XLSX, PPT, PPTX, TXT, CSV, JPG, JPEG, PNG, GIF, SVG, WEBP, MP4, MOV, WEBM, ZIP, RAR`);
