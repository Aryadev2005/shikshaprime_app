...
import { getHeadwiseCollection } from "@/src/services/feeReportService";
...
export default function HeadwiseCollectionReport() {
  ...
  // Convert Redux data → Select options
  ...
  }, [from, to, programId, departmentId, academicYearId, classId]);

  // -----------------------------
  // TABLE COLUMNS
  // -----------------------------
  const columns = ["fee_head", "amount", "students"];

  return (
    <ReportContainer
      title="Head-wise Fee Collection Report"
      filters={
        <ReportFilters className="headwise-collection-filters">
