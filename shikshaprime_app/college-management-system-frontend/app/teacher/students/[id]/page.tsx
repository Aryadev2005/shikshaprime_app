...
import { ArrowLeft, User, Save, X, ChevronLeft, Mail, Phone, Calendar, Hash, Globe, Users, CreditCard, Award, GraduationCap } from "lucide-react";
        ...
        <>
            ...
            <div className="student-details-wrapper">
                ...
                <div className="details-header-card">
                    <Link href={'/teacher/students'} className="bg-primary rounded-md p-2 text-white me-3 w-8 h-8 flex items-center"><ChevronLeft className="h-5 w-5" /></Link><h3 className="text-dark text-lg font-semibold">{isEditMode ? 'Edit Student Details' : 'Student Details'}</h3>
                </div>
                                ...
                                <div className="modern-details-grid">
                                    ...
                                    <div className="detail-item">
                                        ...
                                        <div className="item-content">
                                            ...
                                            <span className="item-value">
                                                {departments?.find((d: any) => d.id === Number(student.department_id))?.name || student.department_id || "-"}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="detail-item">
                                        ...
                                        <div className="item-content">
                                            ...
                                            <span className="item-value">
                                                {student?.caste
                                                    ? ["sc", "st", "obc"].includes(student.caste.toLowerCase())
                                                        ? student.caste.toUpperCase()
                                                        : student.caste.replace(/-/g, " ").toLowerCase().split(" ").map(w => w.charAt(0).toUpperCase() + w.slice(1)).join(" ")
                                                    : "-"}
                                            </span>
                                        </div>
                                    </div>
                                        ...
                                        <div className="item-content">
                                            ...
                                            <span className="item-value">
                                                {student?.id_proof_type
                                                    ? student.id_proof_type.replace(/-/g, " ").split(" ").map(w => w.charAt(0).toUpperCase() + w.slice(1)).join(" ")
                                                    : "-"}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="detail-item">
                                        ...
                                        <div className="item-content">
                                            ...
                                            <span className="item-value">
                                                {classes?.find((c: any) => c.id === Number(student.class_id))?.name || student.class_id || "-"}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="marksheet-section">
                                    ...
                                    <Link target="_blank" href={getDocumentUrl(student?.twelve_marksheet_doc)} className="marksheet-card marksheet-coral relative">
                                        ...
                                        <div className="marksheet-content flex justify-between items-center">
                                            ...
                                            <span className="py-1 px-2 text-sm bg-white/100 text-black rounded-md bottom-8 right-3">Download Marksheet</span>
                                        </div>
                                    </Link>
