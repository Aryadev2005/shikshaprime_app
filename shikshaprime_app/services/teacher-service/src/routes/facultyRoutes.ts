...
router.get("/dashboard/teacher", requireAuth, requireRole("teacher"), getTeacherDashboard);
router.get("/faculty/me/profile", requireAuth, requireRole("teacher"), getMyTeacherProfilePage);
...
router.put("/assignments/:assignmentId", requireAuth, updateAssignment);
...
router.get("/metadata/sections", requireAuth, getSections);
