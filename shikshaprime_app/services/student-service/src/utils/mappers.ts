...
export function mapStudentFromDb(dbRecord: any) {
  return {
    ...
    is_physically_challenged: dbRecord.is_physically_challenged,
    nationality: dbRecord.nationality,
    caste: dbRecord.caste,
    degree: dbRecord.degree,
    id_proof_type: dbRecord.id_proof_type,
    id_proof_number: dbRecord.id_proof_number,
    // Parent information
